    ...
    <div className={`flex flex-col lg:flex-row ${index % 2 ? 'lg:flex-row-reverse' : 'lg:flex-row'} justify-center mt-5 px-4`}>
        ...
        <div className='p-5 w-full lg:w-1/4 flex flex-col justify-center'>
            ...
            <div className='flex flex-col gap-5 mt-4'>
              {live && (
                <a href={live} target='_blank' rel="noopener noreferrer" className='underline decoration-blue-400 decoration-4 hover:bg-blue-400 hover:text-white transition duration-500 w-fit p-2'>PREVIEW</a>
              )}
              {git && (
